...
export const ORDER_ITEM_SELECT = `
  ...
  box_type, urgency, item_notes, stage, production_status, is_delayed, delay_reason,
  assigned_worker_id, media_link, updated_by_worker_id, created_at, updated_at,
  media:order_item_media (id, file_name, mime_type, cloudinary_public_id, storage_path, secure_url, uploaded_at),
  order:orders!inner (
    order_no, client_name, delivery_date, status, stage, assigned_designer_id,
    designer_name, designer_brief, order_notes, media_link, media_notes,
